...
if __name__ == "__main__" :
    ...
    # Create a Day : label
    day = Label(gui, text = "Day", bg = "spring green")
 
    # Create a Month : label
    month = Label(gui, text = "Month", bg = "spring green")
 
    # Create a Year : label
    year = Label(gui, text = "Year", bg = "spring green")
 
    # Create a Given Day : label
    givenDay = Label(gui, text = "Given Day", bg = "spring green")
 
    # Create a Given Month : label
    givenMonth = Label(gui, text = "Given Month", bg = "spring green")
 
    # Create a Given Year : label
    givenYear = Label(gui, text = "Given Year", bg = "spring green")
 
    # Create a Years : label
    rsltYear = Label(gui, text = "Years", bg = "spring green")
 
    # Create a Months : label
    rsltMonth = Label(gui, text = "Months", bg = "spring green")
 
    # Create a Days : label
    rsltDay = Label(gui, text = "Days", bg = "spring green")
 
    # Create a Resultant Age Button and attached to calculateAge function
    resultantAge = Button(gui, text = "Resultant Age", fg = "Black", bg = "Yellow", command = calculateAge)
 
    # Create a Clear All Button and attached to clearAll function
    clearAllEntry = Button(gui, text = "Clear All", fg = "Black", bg = "White", command = clearAll)
